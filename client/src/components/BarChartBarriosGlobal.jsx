/**
 * Grafico de barras horizontales para cuando se pulse sobre todos los barrios 
 * las estadistica de usuarios por barrio
 */
...
function BarChartBarriosGlobal({ data }) {
...
export default BarChartBarriosGlobal;
